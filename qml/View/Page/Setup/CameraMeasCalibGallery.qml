...
VCC.PageSelectionLayout {
    ...
    title: qsTr("Gallery")
    nonAvailableMessage: Store.state.setupCameraMeasCalibGallery.images.empty() ? "- " + qsTr("No images found") + " -" : ""
    ...
    VCD.TrDialog {
        ...
        function show(imageID) {
            detailDialogImg.source = `image://imgprov/cameraMeasCalibImage/${imageID}` 
            open()
        }
    ...
    headerItem: VCL.HeaderBar {
        RowLayout {
            ...
            VCL.PaginationControl {
                ...
                totalElements: Store.state.setupCameraMeasCalibGallery.images.length
    ...
    content: GridLayout {
        ...
        Repeater {
            ...
            model: Store.state.setupCameraMeasCalibGallery.images.slice((pageCtrl.page - 1) * _.numItems, pageCtrl.page * _.numItems)
            ...
            VCImg.Image {
                ...
                cache: false
                source: `image://imgprov/cameraMeasCalibImage/${modelData.id}`
                fillMode: Image.PreserveAspectFit
                ...
                VCL.SelectionTapHandler {
                    ...
                    onTapped: detailDialog.show(delegate.modelData.id)
                }
            }
        }
